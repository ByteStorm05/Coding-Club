            ...
            <div className="flex gap-x-5">
              <div className="grow">
                ...
                <div className="mt-5 inline-flex gap-x-2">
                  <button
                    type="button"
                    className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none transform hover:scale-105 transition-all duration-200"
                  >
                    Buy Now
                  </button>
                  <button
